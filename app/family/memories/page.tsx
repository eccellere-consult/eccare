...
export default async function FamilyMemoriesPicker() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-text-secondary">Choose an elder to view or add shared photos.</p>
      ...
      {relations.length === 0 ? (
        <Card className="mt-8">
          <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
            ...
            <p className="text-text-secondary">You need an accepted elder connection to share memories.</p>
          </CardContent>
        </Card>
      ) : (
